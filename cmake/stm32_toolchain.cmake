...
set(CMAKE_EXE_LINKER_FLAGS "-g ${FPU_FLAGS} -lc -lgcc -mcpu=cortex-m4 -mthumb -static -T ${PROJECT_SOURCE_DIR}/stm32/ld/stm32f746.ld -Wl,--no-gc-sections -Wl,-Map=${CMAKE_CURRENT_BINARY_DIR}/map,--cref")
